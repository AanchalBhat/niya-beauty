...
export default function DataTable(props) {
  const { handleSortChange, sortField, sortOrder, handleActionClick, requestType } = props
  return (
    <React.Fragment>
        ...
        <table className="table table-striped ">
          <thead>
            <tr style={{ textAlign: 'left' }}>
              ...
              <th
                onClick={() => {
                  handleSortChange('is_verified')
                }}
              >
                <FormattedMessage id="reqType" defaultMessage="Req Type"/>{' '}
